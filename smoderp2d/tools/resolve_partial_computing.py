...
def get_indata_lin(tc, args):
    ...
    if tc == 'roff':
        ...
        # import  smoderp2d.tools.save_load_data_nopickle    as sld   # preparated
...
def get_indata_win(tc, args):
    ...
    #      data are saved in dump, can be stored and loaded later on
        ...
        # import  smoderp2d.tools.save_load_data_nopickle    as sld   # preparate
        ...
        outoutdat = get_argv(constants.PARAMETER_PATH_TO_OUTPUT_DIRECTORY) + \
            os.sep + get_argv(constants.PARAMETER_INDATA)
